      ...
      <section className="border-t border-border py-16">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="space-y-5 text-base leading-relaxed text-muted-foreground">
            <p>
              En la mitología celta, <strong className="font-medium text-foreground">Manannán
              mac Lir</strong> es el dios del mar. No lucha contra el océano: lo
              gobierna. Equipa al viajero y le abre la ruta, pero el viajero
              sigue siendo quien decide el rumbo. Esa distinción es el corazón de
              la marca.
            </p>
            <p>
              Hay una imagen, la más antigua y mejor atestiguada, que lo resume:
              donde un marinero ve olas, el experto ve{" "}
              <em className="text-foreground">una llanura florida</em> sobre la
              que cabalgar. Misma realidad, dos lecturas. Esa es la promesa de
              Manann en una sola imagen: convertir lo opaco en terreno legible.
            </p>
            <p>
              El mito es estructura, no disfraz. Cada símbolo se traduce en algo
              operativo o se cae. No hay magia en la interfaz; hay claridad.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          <div className="space-y-5 text-base leading-relaxed text-muted-foreground">
            ...
            <p>
              ...
              <strong className="font-medium text-foreground">condición del
              sector</strong>: el data-entry manual que erosiona márgenes ya de
              un solo dígito. Las pantallas saturadas. La curva de aprendizaje de
              semanas. La IA usada como adorno.
            </p>
            <p>
              Por eso el “no” más importante de Manann: la IA no decide por ti.
              Lee el documento, propone, prepara el expediente. La confirmación
              crítica es siempre humana. Como un buen administrativo que ya ha
              hecho el 90 % del trabajo cuando llegas.
            </p>
          </div>
          <div className="flex items-start gap-3 rounded-lg border border-border bg-card p-6">
            <Icon icon={ShieldCheck} size={20} className="mt-0.5 shrink-0 text-accent" />
            <div>
              <p className="text-sm font-medium text-foreground">
                La IA propone; el humano confirma.
              </p>
              <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                Es el reparto que nos separa de la ola de “IA autónoma” del
