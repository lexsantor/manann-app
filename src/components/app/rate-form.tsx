          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                className="w-full rounded-md border border-border bg-surface-2/30 px-3 py-2 pr-14 text-sm text-foreground outline-none focus:ring-1 focus:ring-primary transition-colors"
              />
