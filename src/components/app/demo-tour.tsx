  ...
  return (
    <>
      ...
      {current && (
        <>
          <div
            className="fixed inset-0 z-50 bg-background/50 backdrop-blur-[2px]"
            onClick={close}
          />
          <div className="fixed bottom-6 right-6 z-[51] w-[calc(100vw-3rem)] max-w-sm rounded-xl border border-border bg-card shadow-xl">
